...
export default class orderConfirmationModel extends Component {
        ...
        return (
            ...
            >
                ...
                <Modal.Footer>
                    ...
                    <button onClick={() => {
                        console.log(this.props.detail.vegitable)
                    }}>click me
                    </button>
                </Modal.Footer>
            </Modal>
    ...
    //     const newAvailableAmount = this.props.detail.avbStock + this.state.amount;
    //     console.log(this.props.detail.sellerName,"sellerName");
    //     console.log(this.props.detail.vegitable,"vegitable");
    ...
    //         vegitable: this.props.detail.vegitable,
