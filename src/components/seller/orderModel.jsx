...
render() {
    return(
        ...
        >
            ...
            <Modal.Body>
                <Form>
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control require type="text" placeholder="Enter Vegetable here" value={this.state.vegitable} onChange={this.onChangevegetable}/>
                    ...
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control require type="number" placeholder="Enter Max Stock here" value={this.state.maxStock} onChange={this.onChangeMaxStock}/>
                        <Form.Text className="text-muted">
                    ...
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control type="number" placeholder="Enter Available Stock here" value={this.state.avbStock} onChange={this.onChangeAvbStock} />
                        <Form.Text className="text-muted">
                    ...
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control type="number" placeholder="Enter Price Per Kg here" value={this.state.pricePerKg} onChange={this.onChangePrivePerKg}/>
                        <Form.Text className="text-muted">
                            Enter price per KG.
                        </Form.Text>
                    </Form.Group>
            ...
            <Modal.Footer>
                <Button variant="primary" type="submit" onClick={ () =>this.addOrder()}>
                    Add Order
                </Button>
